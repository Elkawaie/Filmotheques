...
// Returns the private 'App\Repository\DescriptionRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\DescriptionRepository.php';

return $this->privates['App\Repository\DescriptionRepository'] = new \App\Repository\DescriptionRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
