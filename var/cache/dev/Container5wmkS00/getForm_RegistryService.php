...
return $this->privates['form.registry'] = new \Symfony\Component\Form\FormRegistry(array(0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\ServiceLocator(array('App\\Form\\ActeurType' => function () {
    return ($this->privates['App\Form\ActeurType'] ?? $this->privates['App\Form\ActeurType'] = new \App\Form\ActeurType());
}, 'App\\Form\\FilmType' => function () {
    return ($this->privates['App\Form\FilmType'] ?? $this->privates['App\Form\FilmType'] = new \App\Form\FilmType());
}, 'App\\Form\\GenreType' => function () {
    return ($this->privates['App\Form\GenreType'] ?? $this->privates['App\Form\GenreType'] = new \App\Form\GenreType());
}, 'App\\Form\\RealisateurType' => function () {
    return ($this->privates['App\Form\RealisateurType'] ?? $this->privates['App\Form\RealisateurType'] = new \App\Form\RealisateurType());
