...
class srcDevDebugProjectContainerUrlGenerator extends Symfony\Component\Routing\Generator\UrlGenerator
{
    ...
    public function __construct(RequestContext $context, LoggerInterface $logger = null, string $defaultLocale = null)
    {
        ...
        'acteur_nouveau' => array(array(), array('_controller' => 'App\\Controller\\ActeurController::new'), array(), array(array('text', '/acteur/nouveau')), array(), array()),
        ...
        'film_nouveau' => array(array(), array('_controller' => 'App\\Controller\\FilmController::new'), array(), array(array('text', '/film/nouveau')), array(), array()),
        ...
        'genre_show' => array(array('id'), array('_controller' => 'App\\Controller\\GenreController::show'), array(), array(array('variable', '/', '[^/]++', 'id'), array('text', '/genre')), array(), array()),
        'genre_edit' => array(array('id'), array('_controller' => 'App\\Controller\\GenreController::edit'), array(), array(array('text', '/edit'), array('variable', '/', '[^/]++', 'id'), array('text', '/genre')), array(), array()),
        'genre_delete' => array(array('id'), array('_controller' => 'App\\Controller\\GenreController::delete'), array(), array(array('variable', '/', '[^/]++', 'id'), array('text', '/genre')), array(), array()),
        ...
        'realisateur_show' => array(array('id'), array('_controller' => 'App\\Controller\\RealisateurController::show'), array(), array(array('variable', '/', '[^/]++', 'id'), array('text', '/realisateur')), array(), array()),
        'realisateur_edit' => array(array('id'), array('_controller' => 'App\\Controller\\RealisateurController::edit'), array(), array(array('text', '/edit'), array('variable', '/', '[^/]++', 'id'), array('text', '/realisateur')), array(), array()),
        'realisateur_delete' => array(array('id'), array('_controller' => 'App\\Controller\\RealisateurController::delete'), array(), array(array('variable', '/', '[^/]++', 'id'), array('text', '/realisateur')), array(), array()),
