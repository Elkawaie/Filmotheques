...
$a->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\ServiceLocator(array('App\\Repository\\ActeurRepository' => function () {
    return ($this->privates['App\Repository\ActeurRepository'] ?? $this->load('getActeurRepositoryService.php'));
}, 'App\\Repository\\DescriptionRepository' => function () {
    return ($this->privates['App\Repository\DescriptionRepository'] ?? $this->load('getDescriptionRepositoryService.php'));
}, 'App\\Repository\\FilmRepository' => function () {
...
}, 'App\\Repository\\RealisateurRepository' => function () {
