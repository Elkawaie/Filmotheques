...
// Returns the private 'App\Repository\RealisateurRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\RealisateurRepository.php';

return $this->privates['App\Repository\RealisateurRepository'] = new \App\Repository\RealisateurRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
